...
export const settingGoalWorkflow: Workflow = {
  ...
  modules: [
    ...
    {
      slug: 'goal-setting',
      title: 'Buat Tujuanmu Sekarang',
      description: 'Petakan tujuan besar ke empat aspek hidup agar arah kelas XI lebih jelas.',
      fields: [
        { key: 'academicTarget', label: 'Target Akademik', type: 'textarea', placeholder: 'Contoh: meningkatkan nilai Biologi menjadi 90.' },
        { key: 'careerTarget', label: 'Target Karier', type: 'textarea', placeholder: 'Contoh: masuk jurusan Psikologi.' },
        { key: 'personalTarget', label: 'Target Pribadi', type: 'textarea', placeholder: 'Contoh: lebih disiplin dan percaya diri.' },
        { key: 'socialTarget', label: 'Target Sosial', type: 'textarea', placeholder: 'Contoh: aktif di organisasi sekolah.' },
      ],
    },
    {
      slug: 'rencana-aksi',
      title: 'Langkah Nyata Menuju Tujuanmu',
      description: 'Ubah tujuan besar menjadi rencana bertanggal dengan prioritas P1-P4.',
      fields: [],
    },
    {
  ...
  modules: [
    {
      ...
      description: 'Isi profil simulasi, target setelah lulus, minat, dan kondisi keuangan awal.',
      fields: [
        { key: 'nickname', label: 'Nama panggilan', type: 'text', placeholder: 'Contoh: Iya' },
        { key: 'schoolSnapshot', label: 'Sekolah', type: 'text', placeholder: 'Contoh: SMA Al-Azhar Jakarta' },
        { key: 'classSnapshot', label: 'Kelas', type: 'text', placeholder: 'Contoh: XII IPA 2' },
        { key: 'originCity', label: 'Kota asal', type: 'text', placeholder: 'Contoh: Jakarta' },
        ...
        { key: 'interestArea', label: 'Minat / target jurusan', type: 'select', options: ['Teknik', 'Kesehatan', 'Pendidikan', 'Bisnis', 'Komputer', 'Desain', 'Hukum', 'Sosial', 'Belum tahu', 'Lainnya'] },
