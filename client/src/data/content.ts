...
export const programs: Program[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      'Buat Tujuanmu Sekarang',
      'Langkah Nyata Menuju Tujuanmu',
  ...
  },
  {
    ...
    modules: ['Profil simulasi dan target setelah lulus', 'Pilih kota tujuan', 'Future Ready Board', 'Hasil dan rekomendasi'],
