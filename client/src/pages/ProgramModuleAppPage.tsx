...
function SmartFinancialInsight({ config, data, disabled, moduleSlug, portfolio, updateMany }: { config: Record<string, unknown> | null; data: Record<string, unknown>; disabled: boolean; moduleSlug: string; portfolio: ProgramPortfolio | null; updateMany: (values: Record<string, unknown>) => void }) {
