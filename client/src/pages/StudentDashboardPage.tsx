import { ArrowRight, CalendarCheck2, FileText, WalletCards } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-5 py-7 lg:px-7">
        ...
        <section className="grid gap-5 xl:grid-cols-[1.5fr_0.8fr]">
          <div className="rounded-lg bg-[#101b3f] p-6 text-white">
            <p className="text-sm text-white/55">Selamat datang kembali</p>
        ...
        <section className="mt-7 grid gap-5 xl:grid-cols-[1.35fr_0.65fr]">
          <div className="rounded-lg border border-slate-200 bg-white">
            ...
            <div className="divide-y divide-slate-200">
              {(dashboard?.program.modules ?? []).slice(0, 4).map((module) => (
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-lg border border-slate-200 bg-white p-5"><div className="flex items-center gap-3"><WalletCards className="size-5 text-[#b45309]" /><h2 className="font-semibold text-[#101b3f]">Program berikutnya</h2></div><p className="mt-3 text-sm leading-6 text-slate-500">Setting Goal membantumu mengeksplorasi jurusan dan karier di kelas XI.</p></div>
          </div>
        </section>
      </div>
    </StudentAppLayout>
