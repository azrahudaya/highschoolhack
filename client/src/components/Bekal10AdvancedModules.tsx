...
export const advancedInitialBySlug: Record<string, AdvancedModuleData> = {
  ...
  'target-pengembangan-diri': { developmentAreas: [], confidence: 3, obstacles: [], smartSpecific: '', smartMeasurable: '', smartAchievable: '', smartRelevant: '', smartTimeBound: '', strategy: '', currentProgress: 0 },
